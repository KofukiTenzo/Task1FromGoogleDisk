...
//        }
        ...
        try(BufferedReader reader = new BufferedReader(new InputStreamReader(System.in))){
            System.out.println("\nQuest 1");
            System.out.println(task3.sentenceOfFiveWords(reader.readLine()));

            System.out.println("\nQuest 2");
            System.out.println(task3.removingExtraSpaces("I        am         learning       Java        Core"));

            System.out.println("\nQuest 3");
            String str;
            while (!(str = reader.readLine()).equals("exit")){
                System.out.println(task3.currency(Float.parseFloat(str)));
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
